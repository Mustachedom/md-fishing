...
Lang.Fishing = {
    ...
    inZone = 'Você está agora em uma zona de pesca',
    outZone = 'Você está agora fora da zona de pesca',
}
...
Lang.RepCommand = {
    header = 'Reputação de Pesca',
        fishing = 'Nível de Pesca: %s',
        illegal = 'Nível de Pesca Ilegal: %s',
        magnet = 'Nível de Pesca com Ímã: %s',
        description = 'XP: %s / %s',
}
return Lang